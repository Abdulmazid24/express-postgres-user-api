...
next();
```
*   **কী কাজ করছে?** এটি একটি পাহারাদারের মতো। যখন কোনো রাউটকে আমরা প্রটেক্ট করতে চাই (যেমন `router.get('/', auth(), userController...)`), তখন রিকোয়েস্টটি প্রথমে এই মিডলওয়্যারে আসে।
*   সে প্রথমে চেক করে টোকেন আছে কি না, তারপর টোকেন ভেরিফাই করে।
*   এরপর সে ডাটাবেসে চেক করে ইউজার এখনো অ্যাক্টিভ আছে কি না (`!user.is_active`)। যদি সব ঠিক থাকে, তবে সে `next()` কল করে রিকোয়েস্টটিকে কন্ট্রোলারের কাছে যেতে দেয়।

### ৪.৪ Logger Middleware
```typescript
app.use(logger);
```
